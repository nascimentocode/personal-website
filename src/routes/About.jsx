    ...
    return (
        <section>
            ...
            <div className="section-content">
                ...
                <p>Se tivesse que escolher uma linguagem favorita, seria Python. Sua simplicidade combinada com sua versatilidade me encantam, e sinto-me em casa quando estou codificando nessa linguagem.</p>
                <p>Estou animado com as possibilidades que o futuro reserva e comprometido em continuar a minha jornada de aprendizado constante. Afinal, para mim, o conhecimento nunca é demais e o desenvolvimento é um processo contínuo e empolgante.</p>
                <p>Sinta-se à vontade para explorar meu site e acompanhar minha evolução nesse mundo em constante transformação!</p>
            </div>
        </section>
    )
}
